...
//    public ResponseEntity<?> createPlan(@RequestBody InsurancePlanRequest insurancePlanRequest, Authentication authentication) {
...
//                insurancePlanRequest.getPrice(),
//                insurancePlanRequest.getDescription(),
//                user
//        );
//
//        insurancePlanRepository.save(insurancePlan);
//        return ResponseEntity.ok(new MessageResponse("Insurance plan created successfully!"));
//    }
//
//    @GetMapping
//    @PreAuthorize("hasRole('ROLE_ICOMPANY')")
...
//        existingPlan.setPrice(insurancePlanRequest.getPrice());
