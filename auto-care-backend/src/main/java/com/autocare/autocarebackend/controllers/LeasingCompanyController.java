...
@RestController
@RequestMapping("/api/v1/leasing-companies")
public class LeasingCompanyController {
    ...
    @PostMapping
    public ResponseEntity<?> createLeasingCompany(@Valid @RequestBody SignupRequest signupRequest) {
        ...
        return ResponseEntity.ok(new MessageResponse("Leasing company registered successfully!"));
    }
}
